...
*/
// * Add your code BELOW here
let rounding1 = Number(5.95);
rounding1 = Math.floor(6);
let rounding2 = Number(5.5);
rounding2 = Math.floor(6);
let rounding3 = Number(5.05);
rounding3 = Math.floor(5);
...
*/
// * Add your code BELOW here
let sliceOfPi = Number(myPiFixed);
// * Don't mess with the test code below here!
test('sliceOfPi', () => {
  expect(() => {
    // Prove immutability by attempting to reassign myPiFixed.
